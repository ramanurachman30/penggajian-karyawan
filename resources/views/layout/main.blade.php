            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Menu Table</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{ url('jabatan') }}">Data Jabatan</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ url('karyawan') }}">Data Karyawan</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ url('divisi') }}">Divisi</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ url('absen') }}">Absen Karyawan</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Menu Rekap</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{ url('rekap') }}">Rekap</a></li>
                            <li><i class="fa fa-table"></i><a href="{{ url('rekap') }}">Rekap Jabatan</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="{{ url('layout.main') }}">Dashboard</a></li>
